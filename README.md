...
<h1 id="mainTitle">What is 1 + 1 ? 🤔</h1>
...
<div id="magic">
    <h1>Do you want to see magic? ✨</h1>
    <div class="container">
        <button id="magicYes">Yes 💕</button>
        <button id="magicNo" class="no-btn" style="top:50%; left:60%;">No 😒</button>
    </div>
</div>

<div id="surprise">BIG SURPRISE after 5 seconds, my Sanu 🎉</div>

<div id="loveStage">
    <h1>Do you love me, Sangam babe? ❤️</h1>
    <div class="container">
        <button id="loveYes">Yes 💕</button>
        <button id="loveNo" class="no-btn" style="top:50%; left:60%;">No 😒</button>
    </div>
    <div id="message">I knew it 🥰💖<br>You’re my everything 💞</div>
    <div id="proposal">Will you be mine forever? 💍💖</div>
</div>
